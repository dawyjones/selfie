...
class AsyncT2 extends AsyncTask<String, String, String> {

    String phone, email, password, name, birthday, gender;

    public AsyncT2(String email, String password, String phone, String name, String birthday, String gender){
